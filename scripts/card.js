...
export default class Card {
  ...
  _setEventListeners() {
    ...
    this._photo.addEventListener('click', ()=> {
      this._popupImg.querySelector('.popup__image').src = this._image;
      this._popupImg.querySelector('.popup__image').alt = this._title;
      this._popupImg.querySelector('.popup__description').textContent = this._title;
